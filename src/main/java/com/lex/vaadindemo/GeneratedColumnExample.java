...
public class GeneratedColumnExample extends CustomComponent {
    ...
    public class FillUp implements Serializable {
        ...
        /** Calculates price per unit of quantity (â‚¬/l). */
        public double price() {
            if (quantity != 0.0) {
    ...
    class PriceColumnGenerator implements Table.ColumnGenerator {
        ...
        String calculateAndFormatValue(FillUp fillup) {
            return String.format("%1.2f â‚¬", fillup.price());            
        }
    }
    ...
    class DailyCostColumnGenerator extends ConsumptionColumnGenerator {
        ...
        @Override
        public String calculateValue(FillUp fillup, FillUp prev) {
            return String.format("%3.2f â‚¬", fillup.dailyCost(prev));
        }
    ...
    void extended(VerticalLayout layout) {
        ...
        table.addContainerProperty("price",       Double.class, null, "Price (â‚¬/l)", null, null);
        table.addContainerProperty("total",       Double.class, null, "Total (â‚¬)", null, null);
        table.addContainerProperty("consumption", Double.class, null, "Consumption (l/day)", null, null);
        table.addContainerProperty("dailycost",   Double.class, null, "Daily Cost (â‚¬/day)", null, null);
